...
public class OnDelete implements Runnable{
    ...
    public void run() {
        ...
        if(JOptionPane.showConfirmDialog(mainFrame, "Are you sure you delete the transaction?","Confirm Delte",JOptionPane.YES_NO_OPTION) == JOptionPane.YES_OPTION){
            ...
            else JOptionPane.showMessageDialog(mainFrame, "Transaction not Deleted");
        }
        else return;
